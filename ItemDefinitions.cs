...
public static class ItemDefinitions
{
    ...
    public static readonly HashSet<int> ResourceItemIds = new()
    {
    ...
    // 鱼类ID集合 / Fish ID set
    public static readonly HashSet<int> FishItemIds = new()
    {
        128, // 河豚 / Pufferfish
        129, // 凤尾鱼 / Anchovy
        130, // 金枪鱼 / Tuna
    ...
    {
        return item != null && ResourceItemIds.Contains(item.ParentSheetIndex);
    }
} 